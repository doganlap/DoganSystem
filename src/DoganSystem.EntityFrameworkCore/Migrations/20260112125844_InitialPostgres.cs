...
namespace DoganSystem.EntityFrameworkCore.Migrations
{
    /// <inheritdoc />
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ServiceInterest = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: true),
                    ...
                    ErpNextLeadId = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: true),
                    SyncedToErpNextAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    CreationTime = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    CreatorId = table.Column<Guid>(type: "uuid", nullable: true),
                    LastModificationTime = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    LastModifierId = table.Column<Guid>(type: "uuid", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PythonServiceUrl = table.Column<string>(type: "character varying(512)", maxLength: 512, nullable: true),
                    CreationTime = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    LastModificationTime = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    CreatorId = table.Column<Guid>(type: "uuid", nullable: true),
                    LastModifierId = table.Column<Guid>(type: "uuid", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_EmployeeAgents", x => x.Id);
                });

            migrationBuilder.CreateTable(
                name: "ErpNextInstances",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    Name = table.Column<string>(type: "character varying(256)", maxLength: 256, nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ErpNextInstances", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PaymentProvider = table.Column<string>(type: "character varying(256)", maxLength: 256, nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ContactSubmissions_CreationTime",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EmployeeAgents_ManagerId",
                table: "EmployeeAgents",
                column: "ManagerId");

            migrationBuilder.CreateIndex(
                name: "IX_EmployeeAgents_TeamId",
                table: "EmployeeAgents",
                column: "TeamId");

            migrationBuilder.CreateIndex(
                name: "IX_EmployeeAgents_TenantId",
                table: "EmployeeAgents",
                column: "TenantId");

            migrationBuilder.CreateIndex(
                name: "IX_ErpNextInstances_TenantId",
                table: "ErpNextInstances",
                column: "TenantId");
